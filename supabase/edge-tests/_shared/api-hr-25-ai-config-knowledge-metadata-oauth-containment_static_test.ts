...
const __BTPM_SRC_BASE__ = new URL('../../functions/_shared/api-hr-25-ai-config-knowledge-metadata-oauth-containment_static_test.ts', import.meta.url).href;
// API-HR.25 — AI configuration & knowledge metadata OAuth direct-read containment
// (parameterized static contract test).
//
// Structural inspection of the committed API-HR.25A/B/C migrations only. No live calls.
...
const SUB_STEPS: SubStep[] = [
  {
    ...
    protectedNames: [
      "Authenticated can read active registry",
      "Org admins can read AI model registry",
  ...
  },
  {
    id: "API-HR.25B",
    marker: "API-HR.25B",
    table: "ai_instruction_templates",
    protectedNames: [
      "Org admins can read instruction templates",
      "is_org_admin",
  ...
  },
  {
    id: "API-HR.25C",
    marker: "API-HR.25C",
    table: "knowledge_article_ai_metadata",
    protectedNames: [
      "kc_ai_meta_select_via_article",
      ...
      "trg_kc_ai_meta_touch_updated_at",
      "trg_kc_ai_meta_updated_at",
      "question_examples_protected",
      "answer_rules_protected",
      "forbidden_claims_protected",
      "knowledge_articles",
...
Deno.test("API-HR.25 sub-step migrations are three distinct files", async () => {
