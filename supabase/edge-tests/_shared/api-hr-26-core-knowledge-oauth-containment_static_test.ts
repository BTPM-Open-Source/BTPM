...
const __BTPM_SRC_BASE__ = new URL('../../functions/_shared/api-hr-26-core-knowledge-oauth-containment_static_test.ts', import.meta.url).href;
// API-HR.26 — Core Knowledge Center OAuth direct-read containment
// (parameterized static contract test).
//
// Structural inspection of the committed API-HR.26A/B migrations only. No live calls.
...
const SUB_STEPS: SubStep[] = [
  {
    ...
    protectedNames: [
      "kcat_select_org",
      "trg_encrypt_knowledge_category_fields",
      "trg_encrypt_knowledge_categories",
  ...
  },
  {
    ...
    protectedNames: [
      "karticle_select_scoped",
      "trg_encrypt_knowledge_article_fields",
      "trg_encrypt_knowledge_articles",
      "list_decrypted_knowledge_articles",
      "get_decrypted_knowledge_article",
      "kc_admin_create_article",
      "kc_admin_update_article",
      "kc_admin_publish_article",
      "kc_admin_archive_article",
      "kc_admin_unarchive_article",
      "is_active_user",
      "get_user_org_id",
      "is_org_admin",
      "is_workspace_member",
...
Deno.test("API-HR.26 sub-step migrations are two distinct files", async () => {
