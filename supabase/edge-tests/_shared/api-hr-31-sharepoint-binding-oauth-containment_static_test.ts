...
const __BTPM_SRC_BASE__ = new URL('../../functions/_shared/api-hr-31-sharepoint-binding-oauth-containment_static_test.ts', import.meta.url).href;
// API-HR.31 — SharePoint binding OAuth direct-read containment
// (parameterized static contract test).
//
// Structural inspection of the committed API-HR.31A/B migrations only. No live calls.
...
const SUB_STEPS: SubStep[] = [
  {
    id: "API-HR.31A",
    marker: "API-HR.31A",
    table: "sharepoint_org_site_connections",
    protectedNames: [
      "sposc_select_org",
      ...AUTHORITY_HELPERS,
      ...PROTECTED_HELPERS,
  ...
  },
  {
    id: "API-HR.31B",
    marker: "API-HR.31B",
    table: "sharepoint_workspace_bindings",
    protectedNames: [
      "spwb_select_scoped",
      ...AUTHORITY_HELPERS,
      ...PROTECTED_HELPERS,
      "trg_spwb_touch",
      "library_web_url",
      "library_id_or_drive_id",
      "library_label_or_name",
      "binding_status",
...
Deno.test("API-HR.31 sub-step migrations are two distinct files", async () => {
