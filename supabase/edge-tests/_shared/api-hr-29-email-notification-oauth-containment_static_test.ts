...
const __BTPM_SRC_BASE__ = new URL('../../functions/_shared/api-hr-29-email-notification-oauth-containment_static_test.ts', import.meta.url).href;
// API-HR.29 — Email & Notification operational OAuth direct-read containment
// (parameterized static contract test).
//
// Structural inspection of the committed API-HR.29A/B/C migrations only. No live calls.
...
const SUB_STEPS: SubStep[] = [
  {
    id: "API-HR.29A",
    marker: "API-HR.29A",
    table: "email_payload_snapshots",
    protectedNames: [
      "eps_select_admin",
      ...AUTHORITY_HELPERS,
      ...ENCRYPTION_HELPERS,
      "trg_encrypt_email_payload",
  ...
  },
  {
    ...
    protectedNames: [
      ...
      ...AUTHORITY_HELPERS,
      ...ENCRYPTION_HELPERS,
      "trg_encrypt_notification_payload",
      "trg_notification_encrypt_payload",
  ...
  },
  {
    id: "API-HR.29C",
    marker: "API-HR.29C",
    table: "outbound_email_events",
    protectedNames: [
      "Tenant admins may read outbound email events",
      ...AUTHORITY_HELPERS,
      ...ENCRYPTION_HELPERS,
...
Deno.test("API-HR.29 sub-step migrations are three distinct files", async () => {
